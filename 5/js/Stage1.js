...
BasicGame.Stage1.prototype = {
    create: function () {
		...
		this.enemy1.animations.add('side',[0,1,2,3], .7, true, true);
		this.enemy1.animations.add('up',[4,5,6,7], .7, true, true);
		this.enemy1.animations.add('down',[8,9,10,11], .7, true, true);
		this.enemy1.animations.play('up');
		
		this.enemy2 = this.add.sprite(460,220, 'yenemy');
		this.enemy2.anchor.setTo(.5,.5);
		this.enemy2.animations.add('side',[0,1,2,3], .5, true, true);
		this.enemy2.animations.add('up',[4,5,6,7], .5, true, true);
		this.enemy2.animations.add('down',[8,9,10,11], .5, true, true);
